...
CONFIG = ExperimentConfig(
    dataset_name="south_german",
    display_name="South German Full",
    loader="south_german",
    default_data_path=ROOT / "data" / "SouthGermanCredit.asc",
    ...
    lr_params={"C": 0.010431147746391051, "class_weight": "balanced"},
    xgb_params={
        "n_estimators": 250,
        "max_depth": 2,
